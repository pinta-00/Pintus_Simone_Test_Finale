...
public class QuizSpettacolo extends AppCompatActivity {

    int giusto=0 , totale=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_spettacolo);
        ...
        findViewById(R.id.btn_indietro).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                y.putExtra("spettacolo", txt_risultato.getText().toString());
                startActivity(y);
            }
        });
