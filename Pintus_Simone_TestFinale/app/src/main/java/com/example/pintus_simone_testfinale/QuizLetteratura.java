...
public class QuizLetteratura extends AppCompatActivity {
    int giusto=0 , totale=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz_letteratura);
        ...
        findViewById(R.id.btn_indietro).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                z.putExtra("letteratura", txt_risultato.getText().toString());
                startActivity(z);
            }
        });
